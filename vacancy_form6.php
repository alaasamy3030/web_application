...
if(isset($_SESSION['uid'])){
    ...
    vaction_requests(report_child_care,facultyid,num_of_day,Sick_note, Add_Date , vaction_ID , Doctor_ID)

					VALUES( :zreport,:facultyid,:num,:zcert, now() , :zvac,:zdoc)");
   ...
   <label class="col-md-12">الاسباب</label>
      <input  type="text" name="cos"  class="form-control form-control-line">
                                    ...
                                    <div class="form-group form-group-lg">
                                        <label class="col-sm-3 control-label">صوره من الشهاده المرضيه للوالد او الوالده  </label>
...
<a href="one.php?pdf=6" class="btn btn-primary btn-sm">قوانين الاجازه</a>
