...
if(isset($_SESSION['uid'])){
    ...
    vaction_requests(facultyid,num_of_day,report_child_care, Add_Date , vaction_ID , Doctor_ID)
					...
					VALUES(:facultyid,:num,:zreport, now() , :zvac,:zdoc)");
...
<div class="qequest_form">
       ...
       <label class="col-sm-6 control-label">طلب  كتابيا للموافقه على  اجازه  عارضه  </label>
...
<a href="one.php?pdf=7" class="btn btn-primary btn-sm">قوانين الاجازه</a>
